                  ...
                  <Card key={i.id} className="hover:border-gold/30 transition-colors overflow-hidden">
                    <CardContent className="p-0">
                      <div className="flex flex-col sm:flex-row">
                        <div className="flex sm:flex-row gap-3 sm:flex-1 p-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground mt-1.5">
                              Pagaste {formatIX(cantidad)} • A: {i.otraPersonaNombre} • {formatFecha(i.fecha || i.createdAt || "")}
                            </p>
                            {i.estado && (
                        ...
                        <div className="flex sm:flex-col items-center sm:items-end justify-between gap-2 p-4 sm:px-6 border-t sm:border-t-0 sm:border-l border-border bg-muted/30">
